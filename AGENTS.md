...
This is the authoritative reusable master: darkapoparka/cars-template-carwow. The current user request determines scope. Preserve the existing rendered design unless the requested shared improvement changes it.
